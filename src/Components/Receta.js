...
const Receta = ({ receta }) => {
    ...
    const { inforeceta, guardarId, guardarReceta } = useContext(ModalContext);
                ...
                <div className="card-body">
                    ...
                    <Modal
                        ...
                        <div style={modalStyle} className={classes.paper}>
                            <h4>{inforeceta.strDrink}</h4>
                            <h5 className="mt-4">instrucciones</h5>
                            <p>{inforeceta.strInstructions}</p>
                            <img className="img-fluid my-4" src={inforeceta.strDrinkThumb} alt="imagen" />
